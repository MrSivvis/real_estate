...
echo "<h1 class='page-title'>Nieruchomości na Wynajem</h1>";
...
<?php if ($isLoggedIn): ?>
<form id="filter-form" method="GET" action="rent.php" class="filter-form">
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if ($isLoggedIn) {
            echo "<a href='property_details.php?id=" . $row['id'] . "&source=rent'>Szczegóły</a>";
            $user_id = $_SESSION['id'];
    ...
    echo "<p>Brak nieruchomości na wynajem.</p>";
}
